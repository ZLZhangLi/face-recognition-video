...
if __name__ == '__main__':
    ...
    POSITIVE_TEST_FILE = "./data/split_data/split_positive2.txt"
    NEGATIVE_TEST_FILE = "./data/split_data/split_negative2.txt"
    POSITIVE_SIMILARIY = "./data/split_data_similarity/similarity_split_positive1(2).txt"
    NEGATIVE_SIMILARIY = "./data/split_data_similarity/similarity_split_negative1(2).txt"
    # Positive Test

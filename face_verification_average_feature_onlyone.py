...
if __name__ == '__main__':
    ...
    POSITIVE_TEST_FILE = "Amanda_Beard/3 Amanda_Beard/3"
    NEGATIVE_TEST_FILE = "Amanda_Beard/3"
    POSITIVE_SIMILARIY = "Amanda_Beard/0"
    NEGATIVE_SIMILARIY = "Amanda_Beard/3"
    # Positive Test
